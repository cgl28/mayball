...
export const exportDefinitions: ExportDefinition[] = [
  ...
  { slug: "ticket-forecast", title: "Ticket revenue forecast", description: "Editable ticket planning assumptions, not actual sales.", filenamePart: "ticket-forecast", permission: "financial_rls" },
  ...
  { slug: "other-revenue", title: "Other revenue", description: "Forecast and received non-ticket revenue items.", filenamePart: "other-revenue", permission: "financial_rls" },
